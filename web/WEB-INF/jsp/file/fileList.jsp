...
<ul>
    ...
    <c:forEach var="file" items="${folderList}">
        <li><img src="/images/folder.png" alt="文件夹"/>&nbsp;<a href="${pageContext.request.contextPath}/fileList?path=${path.concat(file)}">${file}/</a></li>
        <br/>
    </c:forEach>
    <c:forEach var="file" items="${fileList}">
        <li><img src="/images/file.png" alt="文件"/>&nbsp;<a href="${pageContext.request.contextPath}/${path.concat(file)}">${file}</a></li>
        <br/>
    </c:forEach>
</ul>
